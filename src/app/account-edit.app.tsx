...
import { ButtonComponent, EmailComponent, FieldComponent } from "Components";
...
export function AccountEdit({}: IAccountProps) {
    ...
    //     handleChangeValue(e.target.value, e.target.name);
    // }, []);
